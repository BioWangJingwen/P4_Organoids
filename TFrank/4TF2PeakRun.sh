...
dir="/chenfeilab/Avocado/P4_Organoids/P4_8TFNet/P4_8_1GetNet/P4_8_1_4_TF2PeakRun/"
mkdir $dir
cd $dir
...
do
  ...
  sed "s/RefSam/$Sam/g" $Refdir/P4_8_1_4TF2PeakRef.R > $dir/P4_8_1_4TF2Peak$Sam.R

  R CMD BATCH P4_8_1_4TF2Peak$Sam.R &
  sleep 2
